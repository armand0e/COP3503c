...
int main(int argc, const char* argv[]) {
    ...
    while (methodIndex < argc) {
        ...
        if (method == "multiply" || method == "subtract" || method == "overlay" || method == "screen") {
            ...
            Image otherImg(argFile);
            if (method == "multiply") {
                sourceImage.multiply(otherImg);
            } 
            else if (method == "subtract") {
                sourceImage.subtract(otherImg);
            } 
            else if (method == "overlay") {
                sourceImage.overlay(otherImg);
            } 
            else if (method == "screen") {
                sourceImage.screen(otherImg);
            }
            methodIndex += 2;
        } 
            ...
            Image green(argFile1);
            Image blue(argFile2);
            sourceImage.combineImages(sourceImage, green, blue);
            methodIndex += 3;
        } 
        else if (method == "flip") {
